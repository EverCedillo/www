...
class WorkerPool(_messages.Message):
  ...
  packages = _messages.MessageField('Package', 12, repeated=True)
  poolArgs = _messages.MessageField('PoolArgsValue', 13)
  taskrunnerSettings = _messages.MessageField('TaskRunnerSettings', 14)
  teardownPolicy = _messages.EnumField('TeardownPolicyValueValuesEnum', 15)
